              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button variant="outline">Request Equipment</Button>
                  </DialogTrigger>
                  <DialogContent>
                    <DialogHeader>
                ...
                <Card>
                  <CardContent className="p-4 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">by SomyaGupta for MECH (2023-2024)</p>
                    </div>
                ...
                <Card>
                  <CardContent className="p-4 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">by SomyaJohn for CSE(2023-2024)</p>
                    </div>
                    <ChevronRight className="h-5 w-5" />
                  </CardContent>
                </Card>
